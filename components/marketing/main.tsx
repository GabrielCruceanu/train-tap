...
const Main = ({}: MainProps) => (
  <section className="antialiased">
    <div className="max-w-screen-2xl px-4 py-16 mx-auto lg:px-6 sm:py-24 lg:py-40">
      <div className="flex flex-col items-center gap-8 xl:gap-16 lg:flex-row">
        <div className="text-center md:max-w-xl lg:text-left xl:shrink-0 lg:max-w-[50%]">
          <div className="flex flex-col gap-4 lg:gap-8 items-center justify-center text-center lg:text-left lg:items-start">
            {" "}
            {/* <a
              href="https://www.producthunt.com/posts/"
              target="_blank"
            ...
            <h1 className={title({ size: "lg" })}>
              Elevate Your
              <span className="lg:block">Fitness Training Business</span>
            </h1>
            <p className="ext-base font-normal md:max-w-3xl md:mx-auto sm:text-xl ">
              Streamline your scheduling, enhance client relationships, and
              focus on delivering exceptional training sessions with TrainTap.
            </p>
          </div>
          ...
          <div className="flex items-center justify-center gap-5 mt-8 lg:justify-start sm:gap-6">
            <div className="flex -space-x-3 overflow-hidden">
              <Image
                className="inline-block w-8 h-8 border border-foreground rounded-full"
            ...
            <div>
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-base font-norma">5.0</span>
              </div>
              <p className="mt-1 text-sm font-normal ">
                Rated Best Over <span className="font-semibold  ">15.7k</span>{" "}
                Reviews
              </p>
            </div>
          </div>
        ...
        <div className="max-w-md lg:max-w-[50%] mx-auto ">
          <Image
            className="object-contain rounded-[1rem] shadow-2xl"
